...
public class CSVPoint implements Serializable
{
	...
	public String toString() {
		return "CSVPoint [cl=" + cl + ", name=" + name + ", id=" + id + ", x_pca=" + x_pca + ", y_pca=" + y_pca
				+ ", z_pca=" + z_pca + ", x_tsne=" + x_tsne + ", y_tsne=" + y_tsne + ", z_tsne=" + z_tsne + ", x_k2="
				+ x_k2 + ", y_k2=" + y_k2 + ", z_k2=" + z_k2 + ", cl_pca=" + cl_pca + ", cl_tsne=" + cl_tsne
				+ ", cl_k2=" + cl_k2 + ", cl_kn=" + cl_kn + "]";
	}
